...
bgOriginal = Image.open('assets/newbg.png').resize((925,500))
...
bgOriginal1 = Image.open('assets/profile.png').resize((275,155))
...
bgOriginal2 = Image.open('assets/add1.png').resize((275,155))
...
bgOriginal3 = Image.open('assets/stocks.png').resize((275,155))
...
bgOriginal4 = Image.open('assets/stats.png').resize((275,155))
...
bgOriginal5 = Image.open('assets/bill.png').resize((275,155))
...
bgOriginal6 = Image.open('assets/exp.png').resize((275,155))
